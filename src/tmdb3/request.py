...
from Plugins.Extensions.TMBD.tmdb3.cache import Cache
...
class Request(urllib.request.Request):
    ...
    def __init__(self, url, **kwargs):
        ...
        for k, v in self._kwargs.items():
            if isinstance(v, str):
                ...
                kwargs[k] = str(v)
        url = '{0}{1}?{2}'.format(self._base_url, self._url, urllib.parse.urlencode(kwargs))
    ...
    def add_data(self, data):
        ...
        urllib.request.Request.add_data(self, urllib.parse.urlencode(data))
